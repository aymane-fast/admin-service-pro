...
export default function EditClient() {
  ...
  useEffect(() => {
    const fetchClient = async () => {
      try {
        ...
        setError(error.response?.data?.message || "Erreur lors du chargement des données du client")
      } finally {
        setLoading(false)
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.response?.data?.message || "Erreur lors de la mise à jour du client")
      setSaving(false)
    }
  }
      ...
      <div className="flex-1 w-full lg:w-auto overflow-x-hidden">
        ...
        <main className="flex-1 p-6">
          <div className="max-w-7xl mx-auto">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-blue-900">Modifier le client</h1>
              <p className="mt-2 text-gray-600">Modifiez les informations du client ci-dessous</p>
            </div>
