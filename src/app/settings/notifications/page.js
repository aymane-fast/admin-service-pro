                  ...
                  <div className="bg-gray-50 rounded-lg px-6 py-8 text-center">
                    ...
                    >
                      <path 
                        ...
                        strokeWidth="2" 
                        d="M30 34h10l-2.81-2.81A4.064 4.064 0 0136 28.316V22c0-6.075-3.373-11.254-8-12.638V8a4 4 0 10-8 0v1.362C15.373 10.746 12 15.925 12 22v6.316a4.064 4.064 0 01-1.19 2.874L8 34h10m12 0v2a6 6 0 11-12 0v-2m12 0H18"
                      />
                    </svg>
                    <h3 className="mt-4 text-sm font-medium text-gray-900">Notification Settings Coming Soon</h3>
                    <p className="mt-2 text-sm text-gray-500">
                      We're working on adding notification configuration options.
