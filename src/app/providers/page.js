...
import PrestatairesTable from '@/components/PrestatairesTable'
            ...
            <div className="bg-blue-900 p-4 sm:p-6 rounded-t-xl">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                >
                  ...
                  <span className="hidden sm:inline">Créer un prestataire</span>
                </Link>
              </div>
            </div>

            <PrestatairesTable searchQuery={searchQuery} />
          </div>
        </div>
      </div>
    </div>
